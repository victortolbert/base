<template>
  <aside class="about">
    ...
    <p>Now, we're going to fluff this cloud. You can do anything your heart can imagine. A tree cannot be straight if it has a crooked trunk. I'm sort of a softy, I couldn't shoot Bambi except with a camera. The least little bit can do so much. It just happens - whether or not you worried about it or tried to plan it.</p>
