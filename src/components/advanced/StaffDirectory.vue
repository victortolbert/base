    ...
    <table class="ui celled table">
      <thead>
        <tr>
          ...
          <th @click="sortBy = 'nationality'">
            Nationality
          </th>
        </tr>
      </thead>
      <tbody>
        <tr v-for="(employee, index) in sortedEmployees" :key="index" @click="$emit('select', employee)">
          <td>
            <img :src="employee.avatar" class="ui mini rounded image">
          </td>
          <td class="capitalize">
            {{ employee.firstName }}
          </td>
