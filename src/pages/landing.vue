                  ...
                  <li class="py-2">
                    <div class="flex items-center">
                      <div>
                        ...
                        ><i class="fas fa-fingerprint" /></span>
                      </div>
                      <div>
                ...
                <div class="pt-6 text-center">
                  ...
                  <div class="mt-6">
                    <button
                      ...
                      type="button"
                    >
                      <i class="fab fa-twitter" /></button><button
                      class="bg-blue-600 text-white w-8 h-8 rounded-full outline-none focus:outline-none mr-1 mb-1"
                      type="button"
                    >
                      <i class="fab fa-facebook-f" /></button><button
                ...
                <div class="pt-6 text-center">
                  ...
                  <div class="mt-6">
                    <button
                      ...
                      type="button"
                    >
                      <i class="fab fa-google" /></button><button
                      class="bg-blue-600 text-white w-8 h-8 rounded-full outline-none focus:outline-none mr-1 mb-1"
                      type="button"
                    >
                ...
                <div class="pt-6 text-center">
                  ...
                  <div class="mt-6">
                    <button
                      ...
                      type="button"
                    >
                      <i class="fab fa-dribbble" /></button><button
                      class="bg-red-600 text-white w-8 h-8 rounded-full outline-none focus:outline-none mr-1 mb-1"
                      type="button"
                    >
                      <i class="fab fa-google" /></button><button
